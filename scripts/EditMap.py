...
filename = raw_input()
inf = open("E:\\Documents\\Android Projects\\reflectbeat\\android\\assets\\songs\\" + filename + ".map", 'r')
outf = open("E:\\Documents\\Android Projects\\reflectbeat\\android\\assets\\songs\\" + filename + ".rbm", 'w')
